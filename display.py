...
@cloup.option("-w", "--warning-threshold", type=cloup.FloatRange(min=0, max=100), default=40.0, show_default=True,
              help="Warning threshold from 0 to 100.")
@cloup.option("-a", "--alert-threshold", type=cloup.FloatRange(min=0, max=100), default=40.0, show_default=True,
              help="Alert threshold from 0 to 100.")
